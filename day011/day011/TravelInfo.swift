...
struct TravelInfo {
    let travel: [Travel] = [
        Travel(title: "하나우마 베이",
               subtitle: "아름다운 자연을 감상할 수 있는 스노쿨링 명소",
        ...
        Travel(title: "쿠알로아 랜치",
               subtitle: "광활한 대자연에서 즐기는 다양하고 재미있는 액티비티",
        ...
        Travel(title: "하와이 여행을 가고싶다면?\n수업이 있는데 가실 생각은 아니시죠?",
               ...
               ad: true),
        Travel(title: "철도 박물관",
               subtitle: "일본 철도의 역사를 둘러볼 수 있는 박물관",
        ...
        Travel(title: "도쿄 디즈니랜드",
               ...
               ad: false),
        Travel(title: "도쿄 타워",
               subtitle: "아름다운 전망을 즐길 수 있는 도쿄의 상징",
        ...
        Travel(title: "동문 재래 시장",
               subtitle: "먹거리와 생활용품을 판매하는, 제주에서 가장 큰 시장",
        ...
        Travel(title: "제주 국제공항",
               subtitle: "면세점이 있어 더욱 사랑받는, 제주 여행의 시작과 끝을 함께하는 공항",
        ...
        Travel(title: "서귀포 매일 올레 시장",
               subtitle: "다양한 농수산물, 잡화, 먹거리를 판매하는 재래 시장",
               ...
               ad: false),
        Travel(title: "성산일출봉",
               subtitle: "유네스코 세계 자연 유산에 등재된, 제주 최고의 일출 명소",
